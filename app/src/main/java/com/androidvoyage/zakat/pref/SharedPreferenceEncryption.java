...
public class SharedPreferenceEncryption {
     ...
     */
    public SharedPreferenceEncryption(String secureKey, boolean encryptKeys) throws SecurePreferencesException {
        try {
     ...
     * @throws SecurePreferencesException
     */
    public SharedPreferenceEncryption(String secureKey) throws SecurePreferencesException {
        this(secureKey, true);
    }
